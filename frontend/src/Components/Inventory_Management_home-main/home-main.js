      ...
      <div className="full-page-container-home">
        <main className="home-content-x">
          <section className="hero-section-x">
            ...
            <p>
              Explore our wide range of motorcycle models, parts, and
              accessories.
            </p>
            <a href="/userhomegallery/motorcycle-models" className="btn-x1">
              View Motorcycle Models
            </a>{" "}
            <a href="/userhomegallery/parts-and-accessories" className="btn-x">
          ...
          <section className="services-repairs-section-x">
            ...
            <div className="services-repairs-container-x">
              <div className="service-card-x">
                ...
                <p>
                  General maintenance recommendations for your motorcycle by
                  mileage or hours.
                </p>
                <a href="#" className="btn-x">
                  Learn More
                </a>
              </div>
              <div className="service-card-x">
                ...
                <p>
                  From oil changes to tune-ups, we offer a wide range of
                  services to keep your motorcycle running smoothly.
                </p>
                <a href="#" className="btn-x">
                  View Services
                </a>
              ...
              <div className="service-card-x">
                <h3>Service Hours</h3>
                <p>
                  Our service hours differ from our store hours. Please check
                  below for our service schedule.
                </p>
                <a href="#" className="btn-x">
              ...
              <div className="service-card-x">
                ...
                <p>
                  Read what our customers have to say about our service and
                  repairs.
                </p>
                <a href="#" className="btn-x">
                  Read Reviews
              ...
              <div className="service-card-x">
                ...
                <p>Check out our current service specials and promotions.</p>
                <a href="#" className="btn-x">
                  View Specials
                </a>
              </div>
              <div className="service-card-x">
                <h3>Customization</h3>
                <p>
                  Let us help you personalize your motorcycle with our
              ...
              <div className="service-card-x">
                ...
                <p>
                  Meet our certified service technicians and learn about their
                  qualifications.
                </p>
                <a href="#" className="btn-x">
                  Meet Our Team
              ...
              <div className="service-card-x">
                ...
                <p>
                  Learn about our warranty and recall policies for your
                  motorcycle.
                </p>
                <a href="#" className="btn-x">
                  View Warranty & Recalls
                </a>
              </div>
            </div>
          </section>
          <section className="about-section-x">
            ...
            <p>
              Jayawarna Auto is a leading provider of high-quality motorcycle
              models, parts, and accessories. With years of experience in the
              industry, we are dedicated to delivering exceptional customer
