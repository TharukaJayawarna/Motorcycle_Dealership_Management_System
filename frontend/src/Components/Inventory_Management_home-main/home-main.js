    ...
    <div className="home-container-x">
      ...
      <main className="home-content-x">
        <section className="hero-section-x">
          ...
          <a href="/userhomegallery/motorcycle-models" className="btn-x1">View Motorcycle Models</a>  <a href="/userhomegallery/parts-and-accessories" className="btn-x">View Parts & Accessories</a>
