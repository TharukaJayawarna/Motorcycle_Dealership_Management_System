...
export default function MiniDrawer() {
  const theme = useTheme(); // Moved useTheme inside the MiniDrawer function
  const [drawerOpen, setDrawerOpen] = React.useState(true); // Renamed `open` to `drawerOpen`
  ...
  return (
    <Box sx={{ display: 'flex' }}>
      ...
      <Drawer variant="permanent" open={drawerOpen}>
        ...
        <List>
          {[
            ...
            { text: 'Report', path: '/reportsupllier', icon: <ReportIcon /> },
      ...
      <Box component="main" sx={{ flexGrow: 1, p: 3 }}>
        <DrawerHeader />
        {/* Add the corresponding routes and components to handle navigation */}
      </Box>
    </Box>
  );
}
